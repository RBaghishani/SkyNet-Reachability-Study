...
def calculations(G, metric):
    ...
    degree_centrality_result_df.to_csv('./output/degree_centrality_result_' + metric + '.csv', index=False)
    ...
    average_neighbor_degree_result_df.to_csv('./output/average_neighbor_degree_result_' + metric + '.csv', index=False)
    ...
    betweenness_centrality_result_df.to_csv('./output/betweenness_centrality_result_' + metric + '.csv', index=False)
    ...
    pagerank_values_result_df.to_csv('./output/pagerank_values_result_' + metric + '.csv', index=False)
    ...
    clustering_coefficient_result_df.to_csv('./output/clustering_coefficient_result_' + metric + '.csv', index=False)
    ...
    results_df.to_csv('./output/merged_df_' + metric + '.csv', index=False)
